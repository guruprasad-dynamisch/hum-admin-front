...
import { ApiResponse, RefreshTokenResponse, UserInfoResponse } from "@models/api.types";
...
export async function userInfoRequest(): Promise<AxiosResponse<ApiResponse<UserInfoResponse>>> {
